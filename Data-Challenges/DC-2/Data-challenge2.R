...
# Model 4: same than model 1 + interactions

logit_cross4 <- train(civ_violence ~  long_guns_seized + cartridge_sezied + army + federal_police  + municipal_police + navy + 
                        perfect_lethality + army*navy + army*long_guns_seized + army*cartridge_sezied + army*federal_police +
                        army*municipal_police + army*perfect_lethality + army*navy + army*long_guns_seized + army*cartridge_sezied + army*federal_police +
                        army*municipal_police + army*perfect_lethality, data = violence_data, trControl=train_control, method="glm", 
                      family="binomial")

print(logit_cross4)
varImp(object=logit_cross4)
plot(varImp(object=logit_cross4),main="GLM - Variable Importance")
